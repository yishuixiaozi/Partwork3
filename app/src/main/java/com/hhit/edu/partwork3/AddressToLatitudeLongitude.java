...
public class AddressToLatitudeLongitude {
    ...
    public void getLatAndLngByAddress(){
        ...
        String url = String.format("http://api.map.baidu.com/geocoder/v2/?"
                +"address=%s&ak=d8DrlRK9shrfR8Mvk41YX2zhTs1tgCL1&output=json" +
                "&mcode=22:7C:57:FD:49:3B:B0:49:BE:45:7C:C0:EF:8E:3B:FE:A8:9C:F5:9D;com.hhit.edu.partwork3",addr);
        URL myURL = null;
