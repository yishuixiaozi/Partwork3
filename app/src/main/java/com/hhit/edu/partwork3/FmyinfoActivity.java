...
public class FmyinfoActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fmyinfo);
    ...
    public void getUserData(){
        ...
        request.getUserByUserid2(userid)
        ...
        switch (v.getId()){
            ...
            case R.id.tv_xiugai://点击修改
                if (tv_xiugai.getText().toString().equals("点击编辑")){
                    ...
                    new SweetAlertDialog(FmyinfoActivity.this, SweetAlertDialog.WARNING_TYPE)
                            .setTitleText("确定保存修改?")
    ...
    public void updateQuser(){
        ...
        HomePageInterface request= RetrofitUtils.newInstence(ApiManager.COMPUTER_BASE_URL).create(HomePageInterface.class);
        request.updateFuserinfo(userBean)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
